  ...
  return (
    <>
      ...
      <div className="w-[90%] p-2 flex flex-col mx-auto  items-center justify-center align-middle rounded-2xl">
        <div className="w-full  grid place-items-center grid-cols-1 sm:grid-cols-2 sm:gap-12 md:grid-cols-3  md:gap-20 lg:grid-cols-4 lg:gap-20   mx-auto justify-center pt-10">
          {filterData?.length
            ? filterData.map((item) => (
