   ...
   <>
     <nav className="w-full h-20 flex items-center bg-orange-600 sticky top-0 shadow-md z-50 ">
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-4 md:px-8  ">
          <div className=" flex  items-center justify-between sm:flex sm:justify-around md:flex md:justify-evenly   lg:flex lg:justify-between">
            ...
            <div className="hidden sm:flex items-center sm:gap-2 md:gap-4 lg:gap-4 text-white   font-bold">
               <Link to={`/`}>
                <p className="text-xl font-semibold flex items-center gap-1 hover:text-black transition">
                  Home
                </p>
              </Link>
            ...
            } className="text-xl font-semibold flex items-center gap-1 hover:text-black transition">
                  Contact
                </button>
{/* https://cors-by-codethread-for-swiggy.vercel.app/cors/ */}
              <Link to="/CartPage">
                <button className="flex items-center gap-1 text-xl font-semibold hover:text-black transition">
