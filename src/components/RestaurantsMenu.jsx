    ...
    <>
      ...
      <div className="w-[60%] bg-orange-100  mt-20 h-100 sm:h-90 md:h-80 mx-auto flex shadow-md gap-1   rounded-xl  p-5">
        <div className=" w-[60%]  flex flex-col gap-5 ">
          <h1 className="mt-5 text-4xl text-orange-600 font-bold  text-start">
            {restInfo.info.name}
          </h1>
          <div className="flex gap-10 text-2xl font-bold">
            <span>
              {restInfo.info.avgRating}(
              <span>{restInfo.info.totalRatingsString}</span>)
            </span>
        ...
        <div className="w-[40%]   ">
          <img
            className="object-cover h-50 rounded-xl shadow-xl w-full"
            src={
      ...
      <div className="w-[60%] h-120 bg-gray-200 mx-auto mt-5 p-10 flex flex-col gap-5 mb-5 rounded-xl">
        ...
        <div className="mx-auto">
          <h1 className="text-2xl font-semibold text-gray-900">
            For Better Exprience Download <strong>Foodie</strong> App Now
          </h1>
        </div>
      </div>
    </>
